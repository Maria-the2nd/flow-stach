      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link href="/workspace/import">
            <Button className="bg-primary hover:opacity-90 text-primary-foreground shadow-lg shadow-primary/20 font-black px-8 h-12 rounded-xl text-base hover:scale-[1.02] active:scale-[0.98] transition-all">
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col items-center justify-center h-80 bg-card/80 backdrop-blur-xl rounded-[32px] border border-white/20 ring-1 ring-white/10 shadow-2xl shadow-primary/5 relative overflow-hidden group">
          ...
          <p className="text-muted-foreground mb-8 text-center max-w-md font-medium leading-relaxed">
            Import your first HTML project to get started with Webflow
            conversion.
          </p>
          <Link href="/workspace/import">
            <Button className="bg-primary hover:opacity-90 text-primary-foreground shadow-lg shadow-primary/20 font-black px-8 h-12 rounded-xl text-base hover:scale-[1.02] active:scale-[0.98] transition-all">
    ...
    <div className="space-y-6">
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-card rounded-2xl p-6 max-w-md w-full shadow-2xl border border-border">
            ...
            <p className="text-muted-foreground mb-6">
              This will permanently delete the project, all its components, and
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-card rounded-2xl p-6 max-w-md w-full shadow-2xl border border-border">
            ...
            <p className="text-muted-foreground mb-4">
              ...
              <strong>ALL {projects?.length} projects</strong>, their
              components, artifacts, and associated data.
            </p>
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-4">
          ...
          <Link href="/workspace/import">
            <Button className="bg-primary text-primary-foreground hover:opacity-90 font-black shadow-lg shadow-primary/20 rounded-2xl px-8 h-12 transition-all hover:scale-[1.02] active:scale-[0.98]">
              <Plus className="w-5 h-5 mr-2" />
              Import Project
            </Button>
          </Link>
          ...
          return (
            <div key={project._id} className="relative group">
              ...
              <Link
                ...
                className="block"
              >
                <div className="bg-card/90 backdrop-blur-xl rounded-[32px] border border-white/20 ring-1 ring-white/10 overflow-hidden flex flex-col h-full shadow-2xl shadow-primary/5 group/card transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_25px_50px_-12px_rgba(168,85,247,0.15)] hover:border-primary/30">
                  <div className="aspect-video bg-gradient-to-br from-accent/20 to-accent/40 relative overflow-hidden flex items-center justify-center border-b border-white/10">
                    ...
                    <div className="absolute top-4 right-4 bg-background/80 backdrop-blur-md text-foreground px-3 py-1.5 rounded-full text-[10px] font-black shadow-lg tracking-wider uppercase flex items-center gap-2 border border-border/50">
                      <div
                        className={`w-1.5 h-1.5 rounded-full ${statusDisplay.color}`}
                      />
                      {statusDisplay.label}
                    </div>
                  </div>
